...
| Eric Chu  | ciire      | Back-end Developer & Database Administrator  |
| Han Sun | hans-um    | Full stack Developer & Quality Assurance |
| Sumit Saharawat | SumitSaharawat | Quality Assurance   |
------
...
------
## Instructions
In order to run the application, both server and frontend should be running. To run them follow the instructions in the readme file under the corresponding directory.